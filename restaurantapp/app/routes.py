...
def search():
	if request.method == 'POST':
		...
		if (city == "Bristol"):
			...
			rest_in_city = get_restaurants(city_rest, city)
			rest_in_city = ["Humble Grape - Islington", "The Oystermen Seafood Bar & Kitchen","Humble Grape - Battersea", "Amrutha Lounge",
							"Oliveira Organic Vegetarian Kitchen", "Pizza Union Dalston"]
			return render_template('search.html', restaurants=rest_in_city, city=city)
